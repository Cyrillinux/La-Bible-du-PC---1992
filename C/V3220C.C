...
*                     VGA 320*200 en 256 couleurs avec quatre          *
*                     pages d'‚cran   . Le programme utilise les       *
*                     routines en assembleur du module V3220CA.ASM     *
**--------------------------------------------------------------------**
*  Auteur           : MICHAEL TISCHER                                  *
*  D‚velopp‚ le     :  4.09.1990                                       *
*  DerniŠe MAJ      : 14.02.1992                                       *
**--------------------------------------------------------------------**
...
**--------------------------------------------------------------------**
*  (BORLAND TURBO C)                                                   *
*  Compilation      : Cr‚er un fichier projet avec le contenu suivant  *
*                       v3220c.c                                       *
*                       v3220ca.obj                                    *
**--------------------------------------------------------------------**
*  Appel            : v3220c                                           *
...
void PrintChar( char caractere, int x, int y, BYTE cc, BYTE cf )
{
 ...
 if( fptr == (CARPTR) 0 )      /* A-t-on d‚j… d‚termin‚ ce pointeur ? */
   fptr = getfontptr();       /*Non : d‚termine avec fonc. assembleur */
...
/***********************************************************************
*  ColorBox: Dessine un rectangle et le remplit avec un motif compos‚ de    *
*             lignes                                         *
**--------------------------------------------------------------------**
*  Entr‚es : X1, Y1 = Coordonn‚es du coin sup‚rieur gauche de la fenˆtre*
*            X2, Y2 = Coordonn‚es du coin inf‚rieur droit de la fenˆtre
